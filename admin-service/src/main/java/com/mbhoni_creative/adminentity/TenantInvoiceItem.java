...
public class TenantInvoiceItem extends BaseEntity {
    ...
    public TenantInvoice getInvoice() { return invoice; }
    public void setInvoice(TenantInvoice invoice) { this.invoice = invoice; }
