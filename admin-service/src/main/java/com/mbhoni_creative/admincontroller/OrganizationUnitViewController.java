...
public class OrganizationUnitViewController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('ORG_VIEW') or hasAuthority('ROLE_ADMIN') or hasAuthority('ROLE_TENANT_ADMIN') or hasAuthority('TENANT_VIEW')")
    ...
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('ORG_EDIT') or hasAuthority('ROLE_ADMIN') or hasAuthority('ROLE_TENANT_ADMIN') or hasAuthority('TENANT_VIEW')")
